...
export default function BookingForm(props: Props) {
    ...
    return <Box sx={{mt: 3}}>
        ...
        <Stack gap={1}>
            ...
            {props.hotel.rooms.map((room) => <Room key={room.id} numDays={days} reserveButtonDisabled={reserveButtonDisabled || room.maxGuests < numGuests} {...room} onSelected={() => reserve(room)} />)}
        </Stack>
